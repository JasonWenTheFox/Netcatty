...
function App({ settings }: { settings: SettingsState }) {
  ...
  const handleFidoPromptSubmit = useCallback((requestId: string, response: string) => {
    ...
    setFidoPromptQueue((prev) => prev.filter((r) => r.requestId !== requestId));
  }, []);
