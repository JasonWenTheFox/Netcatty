...
export const ruAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': 'Оставьте пустым, чтобы использовать значение из списка моделей, если оно доступно; иначе Netcatty применит безопасное значение по умолчанию. Минимум — 1024 токена.',
  'ai.providers.contextWindow.error': 'Введите целое число не меньше 1024 или оставьте поле пустым.',
  ...
  'ai.chat.permObserverDesc': 'Только чтение (Cursor CLI: Ask)',
  'ai.chat.permConfirmDesc': 'Спрашивать перед записью Netcatty (Cursor CLI: agent + force)',
  'ai.chat.permAutoDesc': 'Выполнять свободно (Cursor CLI: agent + force)',
