...
export const enAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': 'Leave blank to use the model list value when available, otherwise Netcatty uses a safe default. Minimum is 1024 tokens.',
  'ai.providers.contextWindow.error': 'Enter a whole number of at least 1024, or leave it blank.',
  ...
  'ai.chat.permObserverDesc': 'Read only (Cursor CLI: Ask)',
  'ai.chat.permConfirmDesc': 'Ask before Netcatty writes (Cursor CLI: agent + force)',
  'ai.chat.permAutoDesc': 'Execute freely (Cursor CLI: agent + force)',
