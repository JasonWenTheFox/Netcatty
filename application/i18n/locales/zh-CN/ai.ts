...
export const zhCNAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': '留空时优先使用模型列表返回的值；如果没有，Netcatty 会使用安全默认值。最小值是 1024 tokens。',
  'ai.providers.contextWindow.error': '请输入不小于 1024 的正整数，或留空。',
  ...
  'ai.chat.permAuto': '自动',
  'ai.chat.permObserverDesc': '只读（Cursor CLI：Ask）',
  'ai.chat.permConfirmDesc': 'Netcatty 写操作前确认（Cursor CLI：agent + force）',
  'ai.chat.permAutoDesc': '自由执行（Cursor CLI：agent + force）',
