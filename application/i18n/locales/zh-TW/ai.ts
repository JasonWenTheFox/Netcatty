...
export const zhTWAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': '留空時優先使用模型列表傳回的值；如果沒有，Netcatty 會使用安全預設值。最小值是 1024 tokens。',
  'ai.providers.contextWindow.error': '請輸入不小於 1024 的正整數，或留空。',
  ...
  'ai.chat.permAuto': '自動',
  'ai.chat.permObserverDesc': '只讀（Cursor CLI：Ask）',
  'ai.chat.permConfirmDesc': 'Netcatty 寫入前確認（Cursor CLI：agent + force）',
  'ai.chat.permAutoDesc': '自由執行（Cursor CLI：agent + force）',
