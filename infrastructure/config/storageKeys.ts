...
/** Version paired with the command blocklist when settings are synchronized. */
export const STORAGE_KEY_AI_COMMAND_BLOCKLIST_SCHEMA = 'netcatty_ai_command_blocklist_schema_v1';
